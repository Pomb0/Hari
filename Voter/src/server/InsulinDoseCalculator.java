...
public interface InsulinDoseCalculator {
	 ...
	 */
	@WebMethod int backgroundInsulinDose(int bodyWeight);
	 ...
	 */
	@WebMethod int personalSensitivityToInsulin(int physicalActivityLevel, int[] physicalActivitySamples, int[] bloodSugarDropSamples);
}